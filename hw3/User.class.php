...
/*
Здесь у меня нарушение Single resposibility  в SOLID
Модель выполняет несвойственные ей функции проверки авторизации юзера
Причем в остальных классах такого нет, только здесь
Не божественный объект, но что-то близкое
Надо вынести как минимум в контроллер, а лучше вообще в отдельный сервис
*/
        if(!$_COOKIE['isAuthorized']) {
            ...
            $i = 0;
/*
Здесь явный случай Blind Faith, $params здесь - данные post формы и они не проверяются
В классе Order у меня есть метод parseFilter, надо его вынести в отдельный класс, отрефакторить и применить здесь
*/
...
/*
То же самое, что в предыдущем примере, нет проверки данных из POST формы
*/
...
/*
Магические числа в запросе. Надо вынести в константы
*/
